...
We take the security of the Nexus Exchange Python SDK seriously.

## Reporting a vulnerability

**Please report security vulnerabilities privately** using GitHub's
[**Report a vulnerability**](https://github.com/nexus-xyz/nexus-exchange-py/security/advisories/new)
